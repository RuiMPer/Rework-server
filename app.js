...
app.use(
  cors({
    credentials: true,
    origin: [`${process.env.FRONTEND_URL}`, "http://finalproject-rework-app-ironhack.s3-website-eu-west-1.amazonaws.com/", "*", "http://finalproject-rework-app-ironhack.s3-website-eu-west-1.amazonaws.com/api"]
  })
)
