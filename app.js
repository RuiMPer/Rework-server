...
app.locals.title = 'Rework - Generated by Rui and Margarida';


// ADD CORS SETTINGS HERE TO ALLOW CROSS-ORIGIN INTERACTION:
app.use((req, res, next) => {
  res.header("Access-Control-Allow-Origin", "http://finalproject-rework-app-ironhack.s3-website-eu-west-1.amazonaws.com");
...
app.use(
  cors({
    // credentials: true,
    origin: [`${process.env.FRONTEND_URL}`, "http://finalproject-rework-app-ironhack.s3-website-eu-west-1.amazonaws.com"]
  })
)
